...
public final class MinestomListenerComponentHandler implements IComponentHandler<EventListener> {
    ...
    public void onDisable(ModuleManager manager, EventListener component) {
        ...
        minestomModuleManager.getServer().getMinecraftServer().getGlobalEventHandler()
